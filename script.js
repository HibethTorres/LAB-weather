...
async function handleFetchClick(){
    ...
    const currentWeather = await fetchWeatherData(latitude, longitude); //Al usar await debemos agregar async antes de la funcion
    currentTemperature.textContent = currentWeather.temperature;
    currentWindSpeed.textContent = currentWeather.windspeed;
}
//Obj de Js es CLAVE VALOR
//input value
//output inner html
//deploy pagex en GitHub para hacer el DEPLOY
//aniadir el wind speed